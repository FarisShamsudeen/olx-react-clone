...
const handleGoogleSignIn = async () => {
  ...
  try {
    ...
    // User signed in successfully, redirect to profile or home page
            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div onClick={() => setLoginPop(false)} className="flex justify-end cursor-pointer font-semibold text-3xl">
                <svg width="25px" height="25px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                  <path class="" d="M878.336 85.333l-366.336 366.315-366.336-366.315h-60.331v60.331l366.336 366.336-366.336 366.336v60.331h60.331l366.336-366.336 366.336 366.336h60.331v-60.331l-366.315-366.336 366.315-366.336v-60.331z"></path>
                </svg>
              </div>
